...
$zoomlevel = mapswap_get_option( 'mapswap_for_tec_zoom_level_single', '15' );

// Zoom levels 19 and 20 don't render the map.
$zoomlevel = min( $zoomlevel, 18 );

$zoomcontrol = mapswap_get_option( 'mapswap_for_tec_zoom_control_single', false );

$mapheight = mapswap_get_option( 'mapswap_for_tec_map_container_height_single', '250' );
$mapwidth  = mapswap_get_option( 'mapswap_for_tec_map_container_width_single', '250' );
