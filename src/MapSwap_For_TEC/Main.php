...
class Main {
	...
	private function templates(): array {
		 ...
		 */
		$templates = apply_filters( 'mapswap_for_tec_templates', $templates );
	...
	public function alter_map_link( string $link ): string {
		...
		if ( ! empty( $map_link ) ) {
			$link = sprintf(
				...
				$map_link,
				esc_html__( 'Click to view it on OpenStreetMap', 'mapswap-for-the-events-calendar' ),
				esc_html__( '+ OpenStreetMap', 'mapswap-for-the-events-calendar' ),
